...
namespace krsclient.net
{
    class RegisterSpecification
    {
        ...
        public RegisterSpecification(string registerName, string datatypeName, string targetTableName)
        {
        ...
        public static RegisterSpecification CreateSpecification(string registerName, string datatypeName, 
            string targetTableName, FieldSpecification[] fieldSpecifications)
        {
            var spec = new RegisterSpecification(registerName, datatypeName, targetTableName)
